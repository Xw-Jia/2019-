...
## 5 线性不可分
上面讲到的软间隔最大化只能解决由于异常点而导致的线性不可分问题，而对于本身的数据集就是非线性的问题就无能为力，根据相关理论对于在低维空间线性不可分的问题，一般将其映射到高维空间后都是线性可分的，我们可以将这一理论运用

到支持向量机中，可以引入一个函数 ϕ(x)，将样本集从当前维度映射到更高的维度，回过头来看我们之前的优化函数：